...
def visualize_matches_orb(image_path1, image_path2, output_dir="featureMatching/orb"):
    # Read images
    ...
    print(f"ORB match visualization saved at: {output_path}")
