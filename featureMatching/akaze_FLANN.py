...
def average_akaze_matching_sequential_flann(
    image_folder,
    ratio_thresh=0.75,
    visualize=False,
    output_dir="featureMatching/akaze_flann"
):
    # ================= AKAZE INITIALIZATION =================
    ...
    for file in image_files:
        ...
        # FLANN butuh tipe uint8 untuk LSH (AKAZE sudah uint8)
        images[file] = img
        keypoints[file] = kp
...
# === Example Usage ===
average_akaze_matching_sequential_flann(
