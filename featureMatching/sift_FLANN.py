...
def average_sift_matching_sequential_flann(
    image_folder,
    ratio_thresh=0.75,
    max_features=100000,
    visualize=False,
    output_dir="featureMatching/sift_flann"
):
    ...
    for file in image_files:
        ...
        # FLANN requires float32 descriptors
        descriptors[file] = des.astype("float32")
        images[file] = img
        keypoints[file] = kp
...
# === Example Usage ===
average_sift_matching_sequential_flann(
