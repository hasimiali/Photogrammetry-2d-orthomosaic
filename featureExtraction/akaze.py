...
def extract_and_draw_akaze(image_path1, image_path2, output_dir="featureExtraction/output_akaze_dots"):
    # Read both images
    ...
    # Use BFMatcher for AKAZE (NORM_HAMMING)
...
# === Example Usage ===
extract_and_draw_akaze("featureExtraction/image1.jpg", "featureExtraction/image2.jpg")
