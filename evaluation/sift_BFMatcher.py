...
def stitch_images_from_folder(folder_path, debug_matches=False,
                              log_path='sift_BFMatcher_pair_evaluation.csv'):
...
if __name__ == "__main__":
    folder_path = "dataset2"  # change if needed

    result = stitch_images_from_folder(
        folder_path,
        debug_matches=False,
        log_path="evaluation/sift/sift_evaluation.csv"
    )

    if result is not None:
        cv2.imwrite("evaluation/sift/stitched_sift_output.jpg", result)
