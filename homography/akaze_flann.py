...
def stitch_two_images_akaze_flann(
    img1,
    img2,
    output_dir="homography/akaze_flann",
    log_path="homography/akaze_flann_log.csv"
):
    ...
    # ================= FLANN (LSH for Binary Descriptor) =================
    FLANN_INDEX_LSH = 6
    index_params = dict(
...
if __name__ == "__main__":
    ...
    result = stitch_two_images_akaze_flann(img1, img2)

    if result is not None:
        cv2.imshow("AKAZE + FLANN Stitching Result", result)
        cv2.waitKey(0)
