...
# ================= STITCH TWO IMAGES (ORB + FLANN) =================

def stitch_two_images_orb_flann(
    img1,
    img2,
    output_dir="homography/orb_flann",
    log_path="homography/orb_flann_log.csv"
):
...
result = stitch_two_images_orb_flann(img1, img2)
