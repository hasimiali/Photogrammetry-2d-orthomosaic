...
# ================= STITCH TWO IMAGES (ORB + BF) =================

def stitch_two_images_orb_bfmatcher(
    img1,
    img2,
    output_dir="homography/orb_bf",
    log_path="homography/orb_bf_log.csv"
):
...
result = stitch_two_images_orb_bfmatcher(img1, img2)
